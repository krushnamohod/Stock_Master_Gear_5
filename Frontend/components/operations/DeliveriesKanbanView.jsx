...
export function DeliveriesKanbanView({ searchTerm, onOperationClick }) {
                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400">
                                            ...
                                            <span>From: {delivery.sourceLocation}</span>
                                        </div>

                                        <div className="pt-3 mt-3 border-t border-slate-100 dark:border-slate-800 flex justify-between items-center">
                                            <span className="text-xs text-slate-500">
                                                {delivery.productLines.length} items
                                            </span>
                                            <span className={cn(
                                                "text-xs font-medium",
                                                delivery.status === 'Done' ? "text-green-600" : "text-slate-400"
                                            )}>
                                                {delivery.status}
                                            </span>
                                        </div>
